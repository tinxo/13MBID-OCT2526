...
with st.form("prediction_form"):
    ...
    with col8:
        ...
        operaciones_mensuales = st.number_input("Operaciones mensuales", min_value=0.0, value=3.0, step=1.0)
...
#######################################################################################
# TODO: adaptar al conjunto de valores que en su proyecto sean requeridos
# al momento de hacer la predicción. Asegurarse de que los nombres de las variables 
# coincidan con los esperados por la API.
# EXTRA: se pueden incorporar los campos originales del dataset sin las transformaciones
#       y la generación de nuevos atributos para que sean cargados por el usuario y 
#       luego procesados en esta instancia antes de ser enviados a la API.
#       Por ejemplo: presion_financiera se calcula a partir de otros atributos.
#########################################################################################
